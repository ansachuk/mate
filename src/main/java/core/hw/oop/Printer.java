...
class Printer {
    ...
    /**
     * Ми створили клас Printer. Він має друкувати різні дані, тому має метод print().
     * Однак наш клас може працювати з різними типами даних:
     ...
     * якщо на вхід приходить рядок та ціле число (int), то метод повертає рядок у форматі
     * рядок> and число>;
     * якщо на вхід приходить масив рядків, то метод повертає рядок із вмістом вхідного масиву
     * (використай метод Arrays.toString()).
